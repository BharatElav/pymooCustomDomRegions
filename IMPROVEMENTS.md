...
| **NB-13** docs fixes | ✓ | doc rot `ba19821` + SEO meta on 38 pages `cdd5565`; API reference now listed + test-enforced, checkpoint `dill` rationale, ThreadPool/GIL tradeoff, `save_history`/shape-contract docs |
